      ...
      initializer "decidim_spam_signal.admin_spam_signal_menu" do
        Decidim.menu :admin_spam_signal_menu do |menu|
          menu.add_item :general,
                        I18n.t("menu.spam_signal.general", scope: "decidim.admin", default: "General"),
          ...
          menu.add_item :condition,
                        I18n.t("menu.spam_signal.conditions", scope: "decidim.admin", default: "Conditions"),
                        ...
                        if: defined?(current_user) && current_user&.read_attribute("admin")
          menu.add_item :flow,
                        I18n.t("menu.spam_signal.flows", scope: "decidim.admin", default: "Flows"),
